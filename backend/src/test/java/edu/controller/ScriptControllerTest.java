...
class ScriptControllerTest {
    ...
    @Test
    void getHomeScript() throws Exception {
        MockHttpServletResponse result = mockMvc.perform(get("/scripts/home.js"))
                .andExpect(status().isOk())
                .andReturn()
                .getResponse();
    ...
    @Test
    void getArticleCreateScript() throws Exception {
        MockHttpServletResponse result = mockMvc.perform(get("/scripts/article-create.js"))
                .andExpect(status().isOk())
                .andReturn()
                .getResponse();
    ...
    @Test
    void getArticleScript() throws Exception {
        MockHttpServletResponse result = mockMvc.perform(get("/scripts/article.js"))
                .andExpect(status().isOk())
                .andReturn()
                .getResponse();
    ...
    @Test
    void getCategoriesScript() throws Exception {
        MockHttpServletResponse result = mockMvc.perform(get("/scripts/categories.js"))
                .andExpect(status().isOk())
                .andReturn()
                .getResponse();
    ...
    @Test
    void getProfileScript() throws Exception {
        MockHttpServletResponse result = mockMvc.perform(get("/scripts/profile.js"))
                .andExpect(status().isOk())
                .andReturn()
                .getResponse();
