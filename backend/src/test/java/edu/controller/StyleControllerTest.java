...
class StyleControllerTest {
    ...
    @Test
    void getArticleCreate() throws Exception {
        MockHttpServletResponse result = mockMvc.perform(get("/styles/article-create.css"))
                .andExpect(status().isOk())
                .andReturn()
                .getResponse();
        ...
        assertThat(result.getContentType())
                .isEqualTo("text/css");
        assertThat(result.getHeader("Content-Disposition"))
                .isEqualTo("inline; filename=\"article-create.css\"");
    }

    @Test
    void getArticleEdit() throws Exception {
        MockHttpServletResponse result = mockMvc.perform(get("/styles/article-edit.css"))
                .andExpect(status().isOk())
                .andReturn()
                .getResponse();
        ...
        assertThat(result.getContentType())
                .isEqualTo("text/css");
        assertThat(result.getHeader("Content-Disposition"))
                .isEqualTo("inline; filename=\"article-edit.css\"");
    }

    @Test
    void getCategories() throws Exception {
        MockHttpServletResponse result = mockMvc.perform(get("/styles/categories.css"))
                .andExpect(status().isOk())
                .andReturn()
                .getResponse();
        ...
        assertThat(result.getContentType())
                .isEqualTo("text/css");
        assertThat(result.getHeader("Content-Disposition"))
                .isEqualTo("inline; filename=\"categories.css\"");
    }
}